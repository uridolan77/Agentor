"""
MountainCar environment for the Agentor framework.

This module provides a MountainCar environment implementation based on the Gymnasium MountainCar environment.
"""
...
try:
    ...
    logger.warning("Gymnasium not available. MountainCarEnv will not work.")
    GYM_AVAILABLE = False


class MountainCarEnv(BaseEnvironment):
    """MountainCar environment based on the Gymnasium MountainCar environment."""
    ...
    def __init__(
        ...
        if not GYM_AVAILABLE:
            raise ImportError("Gymnasium is required for MountainCarEnv")
